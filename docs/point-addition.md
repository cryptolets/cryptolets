...
Cryptolets writes each point-addition (PADD) formula as a C++ sequence of modular operations. To add a curve for an existing formula, you change only the configuration. To add a formula or coordinate system, you add a new kernel.
