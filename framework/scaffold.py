...
DEFAULT_INPUTS = [
    {"name": "x", "decl_type": "ac_int<_N, false>", "type": "ac_int<N, false>", "width": "N"},
    {"name": "y", "decl_type": "ac_int<_N, false>", "type": "ac_int<N, false>", "width": "N"},
]
DEFAULT_TEMPLATE_PARAMS = "int _N"
DEFAULT_TEMPLATE_ARGS = "N"
DEFAULT_DECL_OUTPUT_TYPE = "ac_int<_N+1, false>"
DEFAULT_OUTPUT_TYPE = "ac_int<N+1, false>"
...
def new(kernel, level, force=False):
    ...
    render("kernel.h.j2", p / "include" / f"{kernel}.h", **ctx)
    render("kernel.cpp.j2", p / "src" / f"{kernel}.cpp", **ctx)
    render("kernel_tb.cpp.j2", p / "src" / f"{kernel}_tb.cpp", **ctx)
