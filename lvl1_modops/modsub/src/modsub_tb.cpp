...
//=============================================================================
// Function: main
//   Test the modsub() function using data from CSV files
//-----------------------------------------------------------------------------
...
#if Q_TYPE == FIXED_Q
    stimulus_element.o_sample = CCS_DESIGN(modsub)(
...
int ReadCSV_Samples(string filename, samplesVector_t &samples)
{
  ...
  // CSV file is expected to have 3 columns: a_sample,b_sample,q_sample
