...
//=============================================================================
// Function: main
//   Test the modmul_mont() function using data from CSV files
//-----------------------------------------------------------------------------
...
int ReadCSV_Samples(string filename, samplesVector_t &samples)
{
  ...
  // CSV file is expected to have 4 columns: a_sample,b_sample,q_sample, q_prime_sample
  ...
  while ((row = CsvParser_getRow(csvparser)) ) {
    ...
    stimulus_element.q_prime_sample = parse_ac_int<wide_t::width>(rowFields[3]);
